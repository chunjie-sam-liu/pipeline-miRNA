...
my %opts;
GetOptions(\%opts,"i=s","p=s","list=s","fa=s","g:s","species=s","h");
if (!(defined $opts{i} and defined $opts{p} and defined $opts{list} and defined $opts{fa} and defined $opts{species} ) || defined $opts{h}) { #necessary arguments
&usage;
}
